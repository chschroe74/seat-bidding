...
import 'features/settings/skip_reminders_screen.dart';
                ...
                routes: [
                    ...
                    GoRoute(
                        ...
                        builder: (context, state) => BidsScreen(
                            api: api,
                            reminderRoundId: int.tryParse(
                                state.uri.queryParameters['reminderRoundId'] ?? '',
                            ),
                        ),
                    ),
                    GoRoute(
                        path: '/settings',
                        builder: (context, state) => SettingsScreen(api: api),
                    ),
                    GoRoute(
                        path: '/settings/reminders/skip',
                        builder: (context, state) => SkipRemindersScreen(
                            api: api,
                            requestedRoundId: int.tryParse(
                                state.uri.queryParameters['roundId'] ?? '',
                            ),
                        ),
                    ),
                    GoRoute(
